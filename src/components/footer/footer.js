    ...
    return (
        <div className="footer">
            ...
            <h1><Link to="/certification" style={{ textDecoration: 'none', color: '#d87df6'}}>Certifications</Link></h1>
                ...
                <Col className="links">
            <h1><a style={{ textDecoration: 'none', color: '#d87df6'}} href="https://docs.google.com/document/d/14rBgYYtoOI6CCpZkK3Khsp8ErdOGxJ1d/edit?usp=sharing&ouid=113737866647134835732&rtpof=true&sd=true" target="_blank" rel="noreferrer">View Resume</a></h1>
            </Col>
                </Row>
                <Row>
